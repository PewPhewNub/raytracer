...
public class Ray3Test {
    ...
    public void testRayCreation() {
        ...
        List<Vector3> intersections4 = ray4.intersectSphere(sphere);    
        ...
        assertEquals(intersections4.get(0), new Vector3(0, 0, -1));
        assertEquals(intersections4.get(1), new Vector3(0, 0, 1));
    }
}
